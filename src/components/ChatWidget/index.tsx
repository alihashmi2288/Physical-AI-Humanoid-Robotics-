...
export default function ChatWidget() {
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    { id: 'welcome', role: 'assistant', content: 'Hi there! I\'m your AI learning companion for Physical AI and Robotics. Feel free to ask me anything about ROS 2, simulation, or humanoid robots!', timestamp: Date.now() }
  ]);
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      setMessages(prev => [...prev, {
        id: Date.now().toString(),
        role: 'assistant',
        content: "Oops! I encountered an issue processing your request. Please try asking again in a moment.",
        timestamp: Date.now()
      }]);
    } finally {
      setIsTyping(false);
      ...
      <div className={clsx(
        ...
        {!user ? (
          ...
          <div className="flex-1 flex flex-col items-center justify-center p-8 text-center bg-gray-50 dark:bg-black/20">
            ...
            <h3 className="text-xl font-bold text-gray-800 dark:text-white mb-3">Sign In to Continue</h3>
            <p className="text-gray-500 dark:text-gray-400 mb-8 leading-relaxed text-sm">
              Create an account or sign in to unlock the AI assistant and get personalized help with your learning journey.
            </p>
